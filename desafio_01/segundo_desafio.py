...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print("\n@@@ Operação não realizada! O valor informado do saque excede o limite. @@@")

    elif excedeu_saques:
        print("\n@@@ Operação não realizada! Número Maximo de saques diário exedido.@@@")
...
def criar_usuario(usuarios):
    ...
    if usuario:
        print("\n@@@ Já possui usuarios registrados com este CPF! @@@")
        return
